# Gemini Context Index - Worth Building
...
Shared workflow logic lives in `core/prompts/`. Gemini reads the same prompts
as Claude and Codex. Do not duplicate business logic in Gemini-specific files.
